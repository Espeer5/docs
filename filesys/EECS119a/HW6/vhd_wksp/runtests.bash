...
ghdl -a --work=M32ToK8ClockDiv_TB M32ToK8ClockDiv.vhd
ghdl -a --work=M32ToK8ClockDiv_TB M32ToK8ClockDiv_TB.vhd
...
echo "Compiling VHDL code..."
ghdl -a --work=Btn4Decoder_TB Btn4Decoder.vhd
ghdl -a --work=Btn4Decoder_TB Btn4Decoder_TB.vhd
echo "Testing implementation..."
...
echo "Compiling VHDL code..."
ghdl -a --work=PwmAudioPlayer M32ToK8ClockDiv.vhd
ghdl -a --work=PwmAudioPlayer AddrUnit.vhd
ghdl -a --work=PwmAudioPlayer Btn4Decoder.vhd
